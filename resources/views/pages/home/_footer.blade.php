    ...
    <div class="container max-w-7xl mx-auto px-4">
        <div class="grid md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="#" class="hover:text-orange-500 transition">Xe Tải Nhẹ</a></li>
                    <li><a href="#" class="hover:text-orange-500 transition">Xe Tải Trung</a></li>
                    <li><a href="#" class="hover:text-orange-500 transition">Xe Đầu Kéo</a></li>
                    <li><a href="#" class="hover:text-orange-500 transition">Phụ Tùng</a></li>
                    <li><a href="#" class="hover:text-orange-500 transition">Dịch Vụ Bảo Dưỡng</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="#" class="hover:text-orange-500 transition">Tin Tức</a></li>
                    <li><a href="#" class="hover:text-orange-500 transition">Tuyển Dụng</a></li>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    ...
                    <li class="flex items-center space-x-2">
                        ...
                        <span>Liên hệ 0961549241 Em Hợp</span>
                    </li>
                    <li class="flex items-center space-x-2">
                        <svg class="w-5 h-5 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
